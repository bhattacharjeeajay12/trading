# ===============================
# data_pipeline.py (FULL VERSION)
# ===============================

import pandas as pd
import numpy as np

def prepare_data(df, seq_len=60, horizon_sec=15, threshold=0.05, export_path=r"D:\Study\Programs\trading\Experiments\TCNN\data\processed_with_split.csv"):

    # -------------------------------
    # SORT & TIME CONVERSION
    # -------------------------------
    ...
    for i in range(seq_len, len(df)):
        ...
        y.append(targets[i])
        seq_indices.append(i)  # track mapping
